                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6 mt-3 mt-lg-0">
                                        <div className="single-footer-widget">
                                            ...
                                            <ul className="footer-quick-links list-unstyled">
                                                ...
                                                <li>
                                                    <a href="https://registrasi-isif-2024.vercel.app/" target="_blank">Registration Here</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                        <div className="single-footer-widget">
                                            ...
                                            <ul className="footer-quick-links address-link list-unstyled">
                                                <li>
                                                    <a href="https://goo.gl/maps/gEzFyE9gtXEyRfA26" target="_blank">
                                                        <i className="fa fa-map-marker me-1"></i>
                                                        Jl. Kemang RT 03 RW 06
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="mailto:youngscientist.iysa@gmail.com" target="_blank">
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                        <div className="single-footer-widget">
                                            ...
                                            <ul className="footer-quick-links sosmed list-unstyled">
                                                <li>
                                                    <a href="https://www.facebook.com/Indonesia-Young-scientist-Association-106523338057326" className="facebook" target="_blank"><i className="fab fa-facebook-f"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://wa.me/+6281770914129" className="twitter" target="_blank"><i className="fab fa-whatsapp"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://www.linkedin.com/company/indonesian-young-scientist-association-iysa/" className="linkedin" target="_blank"><i className="fab fa-linkedin-in"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://instagram.com/iysa_official" className="instagram" target="_blank"><i className="fab fa-instagram"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
